...
This outlines how to propose a change to this package. For more detailed
info about contributing to this, and other packages, please see the
[**development contributing
guide**](https://github.com/ArchaeoStat/ArchaeoCal/blob/master/.github/CONTRIBUTING.md).
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ArchaeoStat/PACKAGE", fork = TRUE)`.
...
Conduct](https://github.com/ArchaeoStat/ArchaeoCal/blob/master/.github/CODE_OF_CONDUCT.md).
